...
@section('content')
    ...
    {{-- Hero --}}
    <section class="hero-under-nav relative isolate overflow-hidden bg-brand-500 pt-6 pb-16 text-white sm:pt-32 sm:pb-32 lg:pt-24 lg:pb-40">
            ...
            <div x-data x-intersect.once="$el.classList.add('is-visible')" class="reveal">
                <dl class="overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur divide-y divide-white/10 sm:grid sm:grid-cols-2 sm:divide-x sm:divide-y-0 sm:rounded-3xl lg:grid-cols-3">
                    <div class="flex items-center justify-between gap-4 px-5 py-4 sm:block sm:px-6 sm:py-7 sm:text-center">
                        ...
                        <dd class="font-display text-3xl font-black tracking-tight text-white sm:mt-2 sm:text-5xl lg:text-5xl">$99</dd>
                    </div>
                    <div class="flex items-center justify-between gap-4 px-5 py-4 sm:block sm:px-6 sm:py-7 sm:text-center">
                        <dt class="text-xs font-semibold uppercase tracking-[0.15em] text-accent-300">Agent Transaction Fees</dt>
                        <dd class="font-display text-3xl font-black tracking-tight text-white sm:mt-2 sm:text-5xl lg:text-5xl">$0</dd>
                    </div>
                    <div class="flex items-center justify-between gap-4 px-5 py-4 sm:block sm:px-6 sm:py-7 sm:text-center sm:border-t sm:border-white/10 sm:divide-y-0 lg:border-t-0">
                        ...
                        <dd class="font-display text-3xl font-black tracking-tight text-white sm:mt-2 sm:text-5xl lg:text-5xl">100%</dd>
                    </div>
            ...
            <div class="mt-10 grid items-center gap-8 sm:mt-16 sm:gap-12 lg:grid-cols-12">
                <div class="lg:col-span-7">
                    <div x-data x-intersect.once="$el.classList.add('is-visible')" class="reveal">
                        ...
                        <h1 class="mt-4 text-center font-display text-3xl font-bold leading-[1.08] tracking-tight sm:mt-5 sm:text-6xl lg:text-left lg:text-7xl">
                            Keep <span class="text-gradient">100%</span> of your commission.
                        </h1>
                        <p class="mx-auto mt-4 max-w-xl text-center text-base leading-relaxed text-white/80 sm:mt-6 sm:text-xl lg:mx-0 lg:text-left">
                            $99 a month. Zero agent transaction fees. No franchise fees. No surprises. The math is simple - and it's in your favor.
                        </p>
                        <div class="mt-6 flex flex-wrap items-center justify-center gap-3 sm:mt-10 sm:gap-4 lg:justify-start">
                    ...
                    <div x-data x-intersect.once="$el.classList.add('is-visible')" class="reveal motion-safe:animate-float relative">
                        ...
                        <div class="rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl sm:p-8">
                            ...
                            <div class="mt-6 rounded-2xl border-2 border-accent-400 bg-gradient-to-br from-accent-400 to-accent-500 p-6 text-brand-950 shadow-2xl shadow-accent-400/20">
                                ...
                                <p class="mt-1 font-display text-4xl font-black tracking-tight text-brand-950 sm:text-6xl">$1,188</p>
    ...
    {{-- Calculator --}}
    <section id="calculator" class="bg-slate-50 section-y">
        <div class="page-container">
            <div class="mx-auto max-w-3xl text-center">
                <p class="text-sm font-semibold uppercase tracking-[0.18em] text-brand-500">The math doesn't lie</p>
                <h2 class="heading-section mt-2 text-brand-900 sm:mt-3">
    ...
    <x-section eyebrow="Real agents, real numbers" title="What our agents say.">
        <x-testimonial-slider :testimonials="[
            ['quote' => 'I switched after 14 years at a franchise. My first year at Taylor I kept an extra $32,000. The numbers were honest - no surprises.', 'name' => 'Joelle R.', 'role' => 'Annapolis - 9 years with Taylor'],
            ['quote' => 'The broker actually answers his phone. That alone was worth the move. The fee structure was the cherry on top.', 'name' => 'Marcus T.', 'role' => 'Bowie - 4 years with Taylor'],
            ['quote' => 'I came in as a brand new agent. The mentorship program got me to my first closing in under 90 days.', 'name' => 'Priya K.', 'role' => 'Towson - 2 years with Taylor'],
        ]" />
    </x-section>
